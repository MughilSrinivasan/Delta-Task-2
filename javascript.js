const gunShot = new Audio('gunshot.mp3');
        ...
        var gameArea = 
        {
            ...
            start : function()
            {
                let currTime;
                let prevTime;
                var reqmain = window.requestAnimationFrame(main);
        ...
        class Generator
        {
            ...
            bossElem = () =>
            {
                ...
                gameArea.ctx.fillRect(this.x+this.width/2-5,this.y+this.height,10,20);
                gameArea.ctx.fillStyle = this.color;
                gameArea.ctx.fillRect(this.x,this.y,this.width,this.height);
        ...
        function game()
        {
            ...
            document.getElementById("modelHeading").innerHTML = "DOROID DEFENCE";
            document.getElementById("modelContent").innerHTML = "Welcome to Doroid Defence!. Save yourself and your home base by shooting the enemies. Fortunately, the home base with equipped with an automatic defence turret which can shoot the enemies by its own for a given range. Beware of the boss enemy which can have more power and require more bullets to destroy. Shoot all the 50 enemies to win the battle. Good Luck!";
        }
        ...
        function updateGameArea()
        {
            ...
            else if(countEnemy >= 30 && !isBoss)
            {
                ...
                if(isBoss && !bossEnd)
                {
                    let c6time;
                    let p6time;
                    function task6(c6time)
                    {
                        window.requestAnimationFrame(task6);
                        if((c6time - p6time)/1000 < 4)
                        {
                            return;
                        }
                        p6time = c6time;
                    ...
                    req6 = window.requestAnimationFrame(task6);
                    let c7time;
                    let p7time;
                    function task7(c7time)
                    {
                        window.requestAnimationFrame(task7);
                        if((c7time - p7time)/1000 < 7)
                        {
                            return;
                        }
                        p7time = c7time;
                    ...
                    req7 = window.requestAnimationFrame(task7);
                }
            }
        ...
        function checkPlayer()
        {
            ...
            let playerAttackBoss = false;
            let playerAttackHoming = false;
            ...
            for(let y = 0 ; y < imData1.data.length ; y += 4)
            {
                ...
                else if(imData1.data[y] == 242 && imData1.data[y+1] == 87 && imData1.data[y+2] == 10 && imData1.data[y+3] == 255) 
                {
                    playerAttack = true;
                    break;
                }
                else if(imData1.data[y] == 0 && imData1.data[y+1] == 255 && imData1.data[y+2] == 65  && imData1.data[y+3] == 255)
                {
                    playerAttackBoss = true;
                    break;
                }
                else if(imData1.data[y] == 0 && imData1.data[y+1] == 200 && imData1.data[y+2] == 255  && imData1.data[y+3] == 255)
                {
                    playerAttackHoming = true;
                    break;
                }
            }
            ...
            for(let y = 0 ; y < imData2.data.length ; y += 4)
            {
                ...
                else if(imData2.data[y] == 242 && imData2.data[y+1] == 87 && imData2.data[y+2] == 10 && imData2.data[y+3] == 255) 
                {
                    playerAttack = true;
                    break;
                }
                else if(imData2.data[y] == 0 && imData2.data[y+1] == 255 && imData2.data[y+2] == 65  && imData2.data[y+3] == 255)
                {
                    playerAttackBoss = true;
                    break;
                }
                else if(imData2.data[y] == 0 && imData2.data[y+1] == 200 && imData2.data[y+2] == 255  && imData2.data[y+3] == 255)
                {
                    playerAttackHoming = true;
                    break;
                }
            ...
            for(let y = 0 ; y < imData3.data.length ; y += 4)
            {
                ...
                else if(imData3.data[y] == 242 && imData3.data[y+1] == 87 && imData3.data[y+2] == 10 && imData3.data[y+3] == 255) 
                {
                    playerAttack = true;
                    break;
                }
                else if(imData3.data[y] == 0 && imData3.data[y+1] == 255 && imData3.data[y+2] == 65  && imData3.data[y+3] == 255)
                {
                    playerAttackBoss = true;
                    break;
                }
                else if(imData3.data[y] == 0 && imData3.data[y+1] == 200 && imData3.data[y+2] == 255  && imData3.data[y+3] == 255)
                {
                    playerAttackHoming = true;
                    break;
                }
            ...
            for(let y = 0 ; y < imData4.data.length ; y += 4)
            {
                ...
                else if(imData4.data[y] == 242 && imData4.data[y+1] == 87 && imData4.data[y+2] == 10 && imData4.data[y+3] == 255) 
                {
                    playerAttack = true;
                    break;
                }
                else if(imData4.data[y] == 0 && imData4.data[y+1] == 255 && imData4.data[y+2] == 65  && imData4.data[y+3] == 255)
                {
                    playerAttackBoss = true;
                    break;
                }
                else if(imData4.data[y] == 0 && imData4.data[y+1] == 200 && imData4.data[y+2] == 255  && imData4.data[y+3] == 255)
                {
                    playerAttackHoming = true;
                    break;
                }
            ...
            {
                playerHealth -= 2;
                playerAttackBoss = false;
            }
            if(playerAttackHoming)
            {
                playerHealth -= 5;
                playerAttackHoming = false;
            }
        }
        ...
        function checkHome()
        {
            let homeAttack = false;
            let homeAttackBoss = false;
            let homeAttackHoming = false;
            var imgData1 = gameArea.ctx.getImageData(270,420,180,1);
            for(let u = 0 ; u < imgData1.data.length ; u += 4)
            {
                if(imgData1.data[u] == 242 && imgData1.data[u+1] == 87 && imgData1.data[u+2] == 10  && imgData1.data[u+3] == 255)
                {
                    homeAttack = true;
                    break;
                }
                else if(imgData1.data[u] == 0 && imgData1.data[u+1] == 255 && imgData1.data[u+2] == 65  && imgData1.data[u+3] == 255)
                {
                    homeAttackBoss = true;
                    break;
                }
                ...
                {
                    homeAttackHoming = true;
                    break;
                }
            }
            var imgData2 = gameArea.ctx.getImageData(210,600,1,60);
            ...
            var imgData3 = gameArea.ctx.getImageData(240,420,180,1);
            ...
            var imgData4 = gameArea.ctx.getImageData(209,420,1,60);
            ...
            {
                homeHealth -= 2;
                homeAttackBoss = false;
            }
            if(homeAttackHoming)
            {
                homeHealth -= 5;
                homeAttackHoming = false;
            }
        }
        ...
        {
            bossBullet =  new Generator(bossEnemy.x+25,bossEnemy.y+bossEnemy.height + 15,3,10,"rgba(0,255,65,255)");
        ...
        function stopGame()
        {
            ...
            cancelAnimationFrame(req4);
            cancelAnimationFrame(req5);
